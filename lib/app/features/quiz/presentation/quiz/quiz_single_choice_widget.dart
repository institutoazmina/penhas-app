...
class QuizSingleChoicesWidget extends StatefulWidget {
  const QuizSingleChoicesWidget({
    Key? key,
...
class _QuizSingleChoiceWidgetState extends State<QuizSingleChoicesWidget> {
