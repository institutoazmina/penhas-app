...
class NewTootPage extends StatefulWidget {
  final String title;
  const NewTootPage({Key key, this.title = "NewToot"}) : super(key: key);

  @override
  _NewTootPageState createState() => _NewTootPageState();
}

class _NewTootPageState extends State<NewTootPage> {
